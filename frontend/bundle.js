...
},{"axios":1,"uuid":33}],30:[function(require,module,exports){
...
},{"typed.js":28}],31:[function(require,module,exports){
const axios = require('axios')
...
},{"./editor":29,"./game":30,"./menu":32,"axios":1}],32:[function(require,module,exports){
module.exports = {
	template: '#menuTpl'
}
...
function toHex(x) {
	return x < 10 ? x.toString() : String.fromCharCode('a'.charCodeAt(0) + x - 10)
}
module.exports = () => {
	const arr = []
	...
	for (let i = 0; i < 16; i++) {
		var tmp = t % 16
		arr.push(tmp)
		t = Math.floor((t - tmp) / 16 + 1e-6)
	}
	for (let i = 0; i < 16; i++)
		arr.push(randint(0, 16))
	var ans = ''
	for (let i = 0; i < 32; i++) {
		ans += toHex(arr[i])
		if (i == 7 || i == 11 || i == 15 || i == 19) ans += '-'
	}
	return ans
}
},{}]},{},[31]);
